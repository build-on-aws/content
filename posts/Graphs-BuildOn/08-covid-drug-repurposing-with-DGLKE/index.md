...
We split the data 90-5-5 for training, test, and validation respectively. after acquiring the mebeddings we validate the results by applying following methods. 
