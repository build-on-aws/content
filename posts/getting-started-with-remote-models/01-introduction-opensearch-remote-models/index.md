...
In this series, you will be acquainted with the remote models' feature and learn how to explore its potential over different scenarios. This first part will be dedicated to introduce you to the concept, the implementation model, and understand the use cases you can build with this feature. Parts [two](../02-processing-inferences-using-ai21labs/index.md) and [three](../03-authoring-custom-connectors-opensearch/index.md) of this series will be more hands-on, and will provide you with tutorials so you can learn how to do things yourself. Part [four](../04-troubleshooting-ml-commons-plugin/index.md) is about providing you with tips and tricks on how to troubleshoot things.
...
In the [second part](../02-processing-inferences-using-ai21labs/index.md), you will practice everything you learned here. You will learn how to spin up an development OpenSearch cluster, connect this OpenSearch cluster with the AI21 Labs Jurassic 2 foundation model via the Amazon Bedrock service, and test running inferences against the remote model.
