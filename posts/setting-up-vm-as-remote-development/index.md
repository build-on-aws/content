...
description: Learn how to use a VM using Amazon EC2 as my daily driver to support coding and writing.
tags:
  - remote development
  - ec2
  - neovim
...
Of course, my primary goal is using VM for coding. In this example I am using Neovim. To get started with Neovim, you can install it with Homebrew using the following command:
