...
The thing I enjoy doing most with the outdated technology I collect is making it do things it was never built to do, forcing the very old to work with the very new. What I did here is exactly that. What I did today goes to show how little, some aspects of technology, have changed in the last 40 years. Showing that a 37 year old computer can do something very modern, something that may have been complete science fiction to the people at the time it was released. And that given the growth of cloud computing in this day and age, the importance of optimizing your local hardware is diminishing, as we are all just using our computers as glorified terminals for something way bigger, up in some cloud. Please keep reading for some nostalgia, terminals, and serial connections. Please do not use this hardware in any production environments, or for anything too important (you have been warned).
...
Now that this is all done and configured and we are connected to the internet, it is time to do some Kubernetes. As you may have noticed, I will be cheating in this goal. Yes, the device itself cannot run anything related to Kubernetes. The command `kubectl` is written in GoLang, and am quite certain that no one has written a compiler for it for the Intel 80C85 CPU. Even if we could compile it, it would definitely not fit in its measly 32KB of RAM (around 29K with everything running). So how do we do this? Well, the secret was alluded to all along: we will use a remote server to do our bidding. Yes, this Tandy 102 will be a glorified Terminal, but hey, that is also cool.
