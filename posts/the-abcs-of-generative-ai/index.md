...
- `title` - "The ABCs of Generative AI"
- `description` - "Generative AI has moved so quickly, that many developers haven’t been able to catch up with new technical language. Whether you’re a builder without an AI/ML background, or you’re feeling like you’ve “missed the boat”, this glossary is for you!"
- `tags` - Generative-AI
- `authorGithubAlias` - brookejamieson
- `authorName` - Brooke Jamieson
- `date` - 2023-08-14
...
![N is for Neural Network](/images/n.png)
