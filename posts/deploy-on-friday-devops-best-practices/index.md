...
In this article, I will share some examples of what should be avoided and practices to mitigate the risks and reduce the pain in the Deploy process, which requires technical, cultural, and process capabilities of organizations ready to Deploy on Fridays.
...
I once worked on a team whose tests were performed exclusively by people, and the software only went into production after going through one or more people who carried out tests and manual inspections. They are the most well-meaning, stressed-out people I've ever worked with during all my career.
...
8 am, the time most of our clients start their operations. I work in a company as a software engineer, and we've just deployed a critical change for our entire user base. We're happy to finally ship it, as it's a technical debt payment that make the software better removing afferent coupling that has long taken us a high toll.

8:10 am. No user can use the platform. Long history short: chaos is raging in support, and some of the most influential customers directly call the business people (including CTO and CIO). It was a nightmare, and a perfect example of how a Deploy made for a reduced number of users (canary release) would have mitigated the Deploy risk, caused less pain, and preserved the organization's reputation. 
...
When I started writing this article, I thought of using my own experiences as a consultant and individual contributor to list practices based on the DevOps pillars that I saw as helpful in my day-to-day life as a builder, allowing teams to innovate quickly and at less risk. This article started with a question, and it is the most important best practice. Certify that your team has space to question. The most productive teams I've ever had the opportunity to work on were those that allowed themselves to question the status quo of their work and environment regularly.
