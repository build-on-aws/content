...
![Enable Advanced features for Amazon DynamoDB backups](images/image04.png)
...
![Create new backup vault as shown in screenshot](images/image07.png)

* Optionally, add tags that will help you search for and identify your backup vault.

![Add tag if desired](images/image08.png)
...
![Clik on Create backup vault button](images/image09.png)
...
![Click on Create on-demand backup window to create new on-demand backup job](images/image12.png)
...
![Choose Build a new plan button and input new Backup Plan name](images/image14.png)
...
![Congigure new backup plan according to screenshot](images/image15.png)
...
![Monitor restore job in the console](images/image26.png)
...
![View restored DynamoDB table in the console](images/image27.png)
