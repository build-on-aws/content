...
(Image from the [OpenTelemetry Documentation](https://opentelemetry.io/docs/collector/), © 2022 The OpenTelemetry Authors, used under [CC-BY-4.0](https://creativecommons.org/licenses/by/4.0/) license)
