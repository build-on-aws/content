...
4. Now we will click on the Sagamker IDE url and open Sagemaker studio where we will analyze our raw movie data , perform visualizations and come up with the right set of features for our movie data set.
