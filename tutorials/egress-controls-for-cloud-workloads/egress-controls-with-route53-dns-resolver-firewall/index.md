...
![Simplified distributed deployment](/egress-controls-with-route53-dns-resolver-firewall/images/tutorial-topolgy.png "Simplified distributed deployment used in this tutorial")
...
![Traffic flow for DNS query](/egress-controls-with-route53-dns-resolver-firewall/images/tutorial-setup-3.png "Traffic flow for DNS query")
...
![Navigate to Cloudformation](/egress-controls-with-route53-dns-resolver-firewall/images/Navigate-to-cfn.png "Navigate to Cloudformation")

1. Click on the stack that has been created. 

![Navigate to stack](/egress-controls-with-route53-dns-resolver-firewall/images/select-stack.png "Navigate to stack")

1. Click on `Outputs` and check the resources that are created. 
2. Find the TestHostSession in the key column.  The URL link for TestHostSession opens an interactive shell on an EC2 instance (**TestInstance1** in the earlier diagram) within an AWS Network Firewall protected subnet which you will be using to send test traffic in this tutorial. 
3. Click on the link to connect to it.  You may find it useful to open this in a separate tab so you can return here to use this and the other links as shortcuts.  There are also links to the AWS Network Firewall, Route 53 Resolver DNS Firewall, and Cloudwatch Logs services.

![CloudFormation Output](/egress-controls-with-route53-dns-resolver-firewall/images/output.png "CloudFormation Output")
...
![Manual scanning](/egress-controls-with-route53-dns-resolver-firewall/images/Evaluate-1.png "Manual scanning")
...
![Create a domain list to block the traffic](/egress-controls-with-route53-dns-resolver-firewall/images/lab1-1.png "Create a domain list to block the traffic")
...
![Verify both allow and block domain lists](/egress-controls-with-route53-dns-resolver-firewall/images/lab1-2.png "Verify both allow and block domain lists")

* After entering the domains, click on **Add domain list**. 

![Create Domain List](/egress-controls-with-route53-dns-resolver-firewall/images/lab1-3.png "Create a domain list")
...
![Name rule group](/egress-controls-with-route53-dns-resolver-firewall/images/lab1-4.png "Name the rule group")

* Click on Add rule to add the domain list you just created. 

![Add domain list](/egress-controls-with-route53-dns-resolver-firewall/images/lab1-5.png "Add a domain list")
...
![Select domain list](/egress-controls-with-route53-dns-resolver-firewall/images/lab1-6.png "Select the domain list")
...
![Adding rule](/egress-controls-with-route53-dns-resolver-firewall/images/lab1-7.png "Adding rules")
...
![Check the priority](/egress-controls-with-route53-dns-resolver-firewall/images/lab1-9.png "Check the priority")

* Adding tags are optional. Leave blank and and click **Next**
* On the final **Review and create** screen click on **Create rule group**. 

![Leave tags as default](/egress-controls-with-route53-dns-resolver-firewall/images/lab1-10.png)

*  You can now see the rule group created in the console. Note it is currently **Not Associated** to a VPC. 

![Verify the rule group created](/egress-controls-with-route53-dns-resolver-firewall/images/lab1-14.png "Verify the rule group created")
...
![Associate rule group with a VPC](/egress-controls-with-route53-dns-resolver-firewall/images/lab1-11.png "Associate rule group with a VPC")
...
![Select the VPC](/egress-controls-with-route53-dns-resolver-firewall/images/lab1-12.png "Select the VPC")

* You can see the VPC associated with the rule group once done. 

![Verify the VPC association](/egress-controls-with-route53-dns-resolver-firewall/images/lab1-15.png "Verify the VPC association")
...
![Verify testegress](/egress-controls-with-route53-dns-resolver-firewall/images/lab1-13.png "Verify using the testegress script")
...
![Create a rule group](/egress-controls-with-route53-dns-resolver-firewall/images/lab1-17.png "Create a rule group")

* Click on `Add rule`. 

![add a rule](/egress-controls-with-route53-dns-resolver-firewall/images/lab1-18.png "Add a rule")
...
![Create a rule group](/egress-controls-with-route53-dns-resolver-firewall/images/lab1-19.png "Create a rule group")
...
![Add a managed rule group](/egress-controls-with-route53-dns-resolver-firewall/images/lab1-20.png "Add a managed rule group")
...
![Add a managed rule group](/egress-controls-with-route53-dns-resolver-firewall/images/lab1-27.png "Add another managed rule group")
...
![Create rule group](/egress-controls-with-route53-dns-resolver-firewall/images/lab1-29.png "Create a rule group")

* The newly created rule group is not associated with a VPC. Click on `Associate the VPC`.

![Create rule group](/egress-controls-with-route53-dns-resolver-firewall/images/lab1-30.png "Create a rule group")

* Select `EgressVPC` and Click on `Associate`. 

![Create rule group](/egress-controls-with-route53-dns-resolver-firewall/images/lab1-31.png "Create a rule group")
...
![Test Egress Results](/egress-controls-with-route53-dns-resolver-firewall/images/lab1-32.png "Test Egress Results")
...
![nslookup test](/egress-controls-with-route53-dns-resolver-firewall/images/lab1-33.png "Perform an nslookup test")
...
![Cloudwatch results](/egress-controls-with-route53-dns-resolver-firewall/images/lab1-34.png "View the Cloudwatch results")

* Click on the latest log group. 

![Cloudwatch results](/egress-controls-with-route53-dns-resolver-firewall/images/lab1-35.png "View the Cloudwatch results")

* Search `google.cn` in the search bar aand observe the results. 

![Cloudwatch results](/egress-controls-with-route53-dns-resolver-firewall/images/lab1-36.png "View the Cloudwatch results")
...
![Cloudwatch results](/egress-controls-with-route53-dns-resolver-firewall/images/lab1-37.png "View the Cloudwatch results")
